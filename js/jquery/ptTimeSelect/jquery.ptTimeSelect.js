...
//					+	'			</div>'
					...
					+	'				<div style="width:100px;border:1px solid #000000;padding:1px;background:#FFFFFF;">'
					...
					+	'		</div>'
					+	'		<div class="ui-widget-content ui-corner-all" style="margin-top:.2em;border:1px solid #AAAAAA;">'
					+	'			<div>'
					+	'				<div class="ptTimeSelectTimeLabelsCntr">'
					+	'					<div class="ptTimeSelectLeftPane" style="width: 65%; text-align: center; float: left;" class="">Hour</div>'
				...
				e.find('.ptTimeSelectMin')
					.bind("click", function(){
						...
						// 2010.12.06 함장수 추가============================
						jQuery('.ptTimeSelectMin').removeClass("selected");
				...
				e.find('.ptTimeSelectHr')
					.bind("click", function(){
						...
						// 2010.12.06 함장수 추가============================
						jQuery('.ptTimeSelectHr').removeClass("selected");
						$(this).addClass("selected");
						// 2010.12.06 함장수 추가============================
	 				});
...
jQuery.ptTimeSelect.openCntr = function (ele) {
	...
	if (i.val()) {
		...
		// 2010.12.06 함장수 추가============================	
		var hrReplace = (hr.substring(0, 1)) == '0' ? hr.substring(1, 2) : hr ;
		var minReplace = (min.substring(0, 1)) == '0' ? min.substring(1, 2) : min ;
		$('.ptTimeSelectHr:eq('+hrReplace+')').addClass("selected");
		$('.ptTimeSelectMin:eq('+(minReplace/5)+')').addClass("selected");
		// 2010.12.06 함장수 추가============================
		
	} else {

		// 2010.12.06 함장수 추가============================
		$('.ptTimeSelectHr:eq(0)').addClass("selected");
		$('.ptTimeSelectMin:eq(0)').addClass("selected");
		// 2010.12.06 함장수 추가============================
	}
