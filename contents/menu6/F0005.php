...
$now_url		= "F0005.php";
$write_url		= "F0005_write.php";
$excel_url		= "fn.excel.term.jipgye.php";
$page			= $_GET['page'];
...
// 메인쿼리
$row 			= $sales_dao->selectSalesStaticsTerm($f_date, $t_date,  $gubun);
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" style="height:50px;">
	<tr>
		<td width="50%" valign="bottom"><font color="#08519C" style="size:11px;font-weight:bold"><b>판매 및 거래현황 > 기간별판매집계</b></font></td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
