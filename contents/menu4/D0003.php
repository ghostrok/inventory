...
<table width="100%" cellspacing="0" cellpadding="0" border="0" style="height:50px;">
	<tr>
		<td colspan="" valign="bottom"><font color="#08519C" style="size:11px;font-weight:bold"><b>지정판매소판매 > 전화접수관리</b></font></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
...
<table width=100% border=0 cellspacing=1 cellpadding=2 bgcolor=#D6D7D6>
	...
	<?php 
		...
		$totl_sum_price += $pack_price + $box_price; 
	...
	<td><?=count($row)?>건</td>
	<td>총합계</td>
	<td><?=number_format($totl_sum_price)?>원</td>
	<td></td>
	<td></td>
	<td></td>
	<td></td>
