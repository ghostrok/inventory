...
// 메인쿼리
$row 			= $sales_dao->selectSalesTerm($f_date, $t_date, $is_deposit, $cust_nm, $return_yn='Y');
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" style="height:50px;">
	<tr>
		<td colspan="" valign="bottom"><font color="#08519C" style="size:11px;font-weight:bold"><b>반품 > 반품/파기 현황</b></font></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
