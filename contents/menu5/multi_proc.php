...
if($menu_id == 'E0001') {
	...
	if($cmd == "" || $cmd == "write") {
		...
		if($res == 1) {
			echo "<script>alert('입력되었습니다.'); parent.location.href = 'E0001.php';</script>";
		}
		...
		if($res == 1) {
			echo "<script>alert('수정되었습니다.'); parent.location.href = 'E0001.php';</script>";
		}
		...
		//echo "DEL";
		if($res == 1) {
			echo "<script>alert('삭제되었습니다.'); parent.location.href = 'E0001.php'; </script>";
		}		
