...
$row_cnt		= $master_dao->selectCustomerCnt($sch_gu, $sch_dong, "B");
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" style="height:50px;">
	<tr>
		<td colspan="" valign="bottom"><font color="#08519C" style="size:11px;font-weight:bold"><b>MASTER > 거래처 관리</b></font></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
...
<table align="right">
	<tr>
		<td><input type="button" value=단일입력 onclick="location.href='A0003_write.php';" class="button_70" /></td>
